...
```{r out.width = "100%", fig.cap = '*The RStudio window.*'}
knitr::include_graphics(here::here("figure", "rstudio.png"))
```
...
knitr::include_graphics(here::here("figure", "friends.png"))
```
