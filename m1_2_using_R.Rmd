...
```{r out.width = "100%", fig.cap = '*Beginning a new project in RStudio.*'}
knitr::include_graphics(here::here("figure", "rstudio_proj.jpg"))
```
...
```{r out.width = "100%", fig.cap = '*Opening a new script in RStudio.*'}
knitr::include_graphics(here::here("figure", "rstudio_script.jpg"))
```
...
```{r out.width = "100%", fig.cap = '*Running code in RStudio.*'}
knitr::include_graphics(here::here("figure", "rstudio_run.jpg"))
```
...
```{r out.width = "100%", fig.cap = '*Illustration by @allison_horst.*'}
knitr::include_graphics(here::here("figure", "debugging.jpg"))
```
