...
Ok, so now we can make our data spatial, we can look at some preliminary plots, but what's next? Let's look at the next lesson to do some spatial operations on our data and make a map that we could actually use or share.
