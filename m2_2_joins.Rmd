...
There are quite a few different join types that are available via the **{dplyr}** package. Here are some great animations by Garrick Adenbuie that may help illustrate the various join types. 
