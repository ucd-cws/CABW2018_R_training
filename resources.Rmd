...
`r icon::fa("code", color="darkpurple", size=1.5, pull="left")` For live-coding, please refer to this [**link**](https://dl.dropboxusercontent.com/s/k5w37n772eu5knx/cabw_script.R?dl=0) with your favorite browser. This will update every time we save, which means you can refresh the page to see whatever code we are typing, and download this file at anytime.
